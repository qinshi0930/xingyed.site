...
export const STACKS: stacksProps = {
	...
	// "Material UI": <SiMui size={iconSize} className="text-red-400" />,
	"Shadcn UI": <SiShadcnui size={iconSize} className="text-sky-400" />,
	...
	"Hono.js": <SiHono size={iconSize} className="text-green-400" />,
