...
`;var N=a.i(85688);let O=()=>(0,b.jsx)(N.motion.div,{className:"my-3 flex h-screen flex-col",initial:{y:-100},animate:{opacity:1,y:0},transition:{duration:.3},children:(0,b.jsx)(o,{})}),P=({expandMenu:a,setExpandMenu:d})=>(0,b.jsx)(Q,{className:"flex lg:hidden",onClick:()=>{d(!a)},children:[{index:1},{index:2},{index:3}].map(d=>(0,b.jsx)(R,{className:(0,c.default)("bg-neutral-950 dark:bg-neutral-100 ",a&&"active")},d.index))}),Q=K.default.div`
	display: flex;
