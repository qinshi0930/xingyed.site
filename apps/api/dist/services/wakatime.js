...
exports.getALLTimeSinceToday = exports.getReadStats = void 0;
...
const getReadStats = async () => {
    const response = await axios_1.default.get(`${STATS_ENDPOINT}/last_7_days`, {
        headers: {
...
exports.getReadStats = getReadStats;
const getALLTimeSinceToday = async () => {
    const response = await axios_1.default.get(ALL_TIME_SINCE_TODAY, {
        headers: {
            Authorization: `Basic ${API_KEY}`,
        },
    });
...
exports.getALLTimeSinceToday = getALLTimeSinceToday;
