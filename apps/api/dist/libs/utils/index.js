...
exports.replaceLastDotWithDash = replaceLastDotWithDash;
exports.replaceLastDashWithDot = replaceLastDashWithDot;
 ...
 */
function replaceLastDotWithDash(str) {
 ...
 */
function replaceLastDashWithDot(str) {
    const lastDotIndex = str.lastIndexOf("-");
    if (lastDotIndex !== -1) {
        return `${str.slice(0, lastDotIndex)}.${str.slice(lastDotIndex + 1)}`;
    }
