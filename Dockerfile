...
# apps/app/.next/standalone/apps/app/ - Next.js standalone 输出（包含 server.js 和 node_modules）
...
# 注意：standalone 内部已包含 monorepo 路径结构，需要再嵌套一层
COPY apps/app/.next/standalone/apps/app/ ./
